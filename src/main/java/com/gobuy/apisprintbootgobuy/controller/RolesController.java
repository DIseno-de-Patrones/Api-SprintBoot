package com.gobuy.apisprintbootgobuy.controller;

import com.gobuy.apisprintbootgobuy.domain.model.Role;
import com.gobuy.apisprintbootgobuy.domain.service.RoleService;
import com.gobuy.apisprintbootgobuy.resource.RoleResource;
import com.gobuy.apisprintbootgobuy.resource.SaveRoleResource;
...
public class RolesController {
    ...
    @Operation(summary = "Get Roles", description = "Get All Roles", tags = {"Roles"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get Role", description = "Get Role by name", tags = {"Roles"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Role returned", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "404", description = "Role not found")
    })
